            ...
            <main>
                ...
                <div id="overlay" class="overlay">
                    ...
                    <div id="title" class="title hidden">
                        ...
                        <button id="board-editor" class="board-editor titlebubble button opacity-0_5">Board Editor</button>
                    </div>
                    ...
                    {/* <!-- This is absolutely positioned. Our javascript will udate it's 'top' ruleset based on the height of the navigation bar. --> */}
                    <div id="stats">
                    ...
                    <div id="navigation" class="hidden unselectable">
                        ...
                        <div class="navigation">
                            ...
                            <div class="coords selectable" >
                                <div id="position">
                                    <div class="x">X: <span id='x'></span></div>
                                    <div class="y">Y: <span id='y'></span></div>
                                </div>
                            </div>
                            <div class="right-nav">
                                <div class="buttoncontainer">
